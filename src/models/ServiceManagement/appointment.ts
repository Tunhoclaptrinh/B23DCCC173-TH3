...
//     }
//   };
//   services: number[]; // Array of service IDs this employee can provide
// }
...
//     // Ensure employee has services array
...
//     // Also update any employees that offer this service
//     const updatedEmployees = employees.map(employee => {
//       if (employee.services && employee.services.includes(serviceId)) {
//         return {
//           ...employee,
...
//     return employee && employee.services && employee.services.includes(serviceId);
//   };
